...
export default function AdminCustomize() {
  ...
  const handleSave = async (e) => {
      ...
      try {
          const app = initFirebase()
          const db = getFirestore(app)
          const binRef = doc(db, 'bins', String(selectedBinId))
      ...
      <div className="dashboard-wrapper">
        ...
        <main className="main-content">
          <div className="dashboard-content">
            ...
            {/* Three Column Layout */}
            <div className="customize-layout admin-customize-layout">
                {/* Bin List (Left) */}
                ...
                <div className="customize-bin-config admin-customize-config">
                    <div className="config-header">
                        <h3 className="config-title">Bin Configuration</h3>
                        <div className="config-actions">
                            <button className="config-btn config-btn--danger" onClick={() => { setRemoveReason(''); setShowRemoveModal(true); }} disabled={!selectedBinId}>
                ...
                {/* Bin Preview (Right) */}
                <div className="customize-bin-preview admin-customize-preview">
                    <div className="config-header">
